...
export default {
    data: new Discord.SlashCommandBuilder()
        ...
        .addStringOption((category) => category
        .setName("category")
    ...
    async execute(client, i) {
            ...
            await i.reply({
                embeds: [
                    new Discord.EmbedBuilder()
                        ...
                        .setDescription(client.commands.slash
                        .reduce((total, command) => {
                        if (command.category === options.category)
                            total += `**${command.data.name}** | ${command.data.description.slice(0, 20)}\n`;
                        return total;
                    }, "")
                        .slice(0, 4e3))
                        .setFooter({
        ...
        const categories = client.commands.slash.reduce((total, command) => {
